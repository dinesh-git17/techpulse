...
class TestSingleWriterMultipleReader:
    """Test suite for SWMR (Single-Writer/Multiple-Reader) behavior."""

    def test_read_connection_while_writer_exists(self) -> None:
        """Verify a read-only connection can query while writer holds connection."""
